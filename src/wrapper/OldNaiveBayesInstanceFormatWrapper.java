...
public class OldNaiveBayesInstanceFormatWrapper {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<String> feature = OldNaiveBayesInstanceFormatWrapper.readTopFeature(featFilePath, 0.5);
        OldNaiveBayesInstanceFormatWrapper.translateTrainOrTestStructure(trainFilePath,
                "C:/Users/Mark/workspace/ClassifyAbstracts/data/abstract/train",
                feature);
        OldNaiveBayesInstanceFormatWrapper.translateTrainOrTestStructure(testFilePath,
