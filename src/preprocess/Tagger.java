...
public class Tagger {
    ...
    public List<TaggedWord> tagSentence(List<Word> sent) {
        if (sent == null) return null;
        
        return tagger.apply(sent);
    }
    
    public List<List<TaggedWord>> tagSentences(List<List<Word>> seperatedSents) {
        ...
        for (List<Word> ssent : seperatedSents) {
            taggedSents.add(tagSentence(ssent));
        }
        return taggedSents;
    }
    ...
    public static void main(String[] args) {
        ...
        List<List<TaggedWord>> taggedSents = tagger.tagSentences(seperatedSents);
