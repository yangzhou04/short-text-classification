...
public class InputToFeatureSet {
    ...
    public InputToFeatureSet(Properties p) {
        props = p;
    ...
    public void labeledFeatureSet(String csv, String opath) throws IOException {
        int count = 0;
    ...
    public void unlabeledFeatureSet(String csv, String opath)
            throws IOException {
        // POS tagger model
        int count = 0;
        BufferedReader br = new BufferedReader(new InputStreamReader(
